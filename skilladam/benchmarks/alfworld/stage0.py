"""ALFWorld-specific Stage0 prompt context."""

from __future__ import annotations

from pathlib import Path

from skilladam.benchmarks.alfworld.rollout import SYSTEM_PROMPT
...
def build_stage0_context(
    *,
    ...
    """Build shared Stage0 context with ALFWorld prompt resources."""

    return Stage0PromptContext(
        trajectory_count=trajectory_count,
        benchmark_domain_info_md=benchmark_domain_info_md,
        vendor_prompt=SYSTEM_PROMPT,
